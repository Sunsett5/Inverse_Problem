...
orig_path = 'exp/learned_results/learned_20steps_100samples/orig'
generated_path = 'exp/learned_results/learned_20steps_100samples/generated'
...
with torch.no_grad():
    for k in tqdm.tqdm(range(N)):
        ...
        denoise_path = os.sep.join([generated_path, '{}_7.png'.format(k)])
